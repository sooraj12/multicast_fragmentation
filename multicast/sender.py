...
from .constants import FAMILY, INTERFACE_IP, iface_index, GROUP_IP, PORT, BUFFER_SIZE, RATE_LIMIT, SLEEP_TIME
...
def send_message(data):
    ...
    sender.setsockopt(socket.IPPROTO_IP, socket.IP_MULTICAST_IF, struct.pack("!I", iface_index))
