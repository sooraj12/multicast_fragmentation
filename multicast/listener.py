...
from .constants import FAMILY, INTERFACE_IP, PORT, GROUP_IP, iface_index, BUFFER_SIZE, BUFFER_OFFSET, HEADER
                ...
                if header_id == HEADER:
                    ...
                    if(len(decode_directory[uid]) == size):
                        ...
                        with gzip.GzipFile(fileobj=buffer) as f:
                            ...
                            message = msgpack.unpackb(decompressed_content, encoding="utf-8")
                        del decode_directory[uid]
                        print(f"=================Buffer:{decode_directory}=============")
                        try:
